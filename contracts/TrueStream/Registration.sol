...
contract Registration is Operatable, IRegistration {
  ...
  function ship(string[] memory imeis, address[] memory addrs) public override onlyOperator {
  ...
  function setOwner(string memory imei, address owner) public override onlyOperator {
