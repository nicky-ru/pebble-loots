  ...
  return (
    <Icon width="274" height="426" viewBox="0 0 274 426" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        fill={background}
      />
      <path d="M186 221L261.896 221C271.124 221 276.899 230.982 272.299 238.982L168.403 419.67C162.277 430.323 146 425.977 146 413.689L146 261C146 238.909 163.909 221 186 221Z" fill={background} />
      <path
        ...
        fill={foreground}
      />
      <path d="M156 191L231.896 191C241.124 191 246.899 200.982 242.299 208.982L138.403 389.67C132.277 400.323 116 395.977 116 383.689L116 231C116 208.909 133.909 191 156 191Z" fill={foreground} />
    </Icon>
  );
};
